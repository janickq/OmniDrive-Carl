...
public class ArmTest extends AutoCommand {
    ...
    public ArmTest(){
        ...
        super(
            // new WaitCommand(3),
             new MoveRobot(1, 1.15, 0, 0, spd1)
            // new MoveRobotSense(1, 20, 0, spd1, spd1, ()-> m_sensor.getIRDistance1()<50),
            // new MoveRobot(1, 0.25, spd1, 0, spd1),
            // new MoveRobot(2, -Math.PI/2, 0, 0, 1),
            // new MoveRobotSense(1, 5, 0, 0, spd2, ()-> m_sensor.getCobraTotal()>8000),
            // new MoveRobot(1, -0.2, 0, 0, spd2),
            // new MoveRobotSense(0, 5, 0, 0, spd2, ()-> m_sensor.getCobraTotal()>8100),
