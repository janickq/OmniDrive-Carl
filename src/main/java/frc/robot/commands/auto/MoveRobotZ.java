 ...
 */
public class MoveRobotZ extends CommandBase
{
    ...
    public MoveRobotZ(double startSpeed, double endSpeed, double maxSpeed)
    {
        _endSpeed = endSpeed;
    ...
    public void execute()
    {
        ...
        m_drive.setRobotSpeedType(0, m_setpoint.velocity*m_dir);
        ...
        if ((m_setpoint.position>=m_goal.position) || endCondition()) {
            ...
            //sensor value etc.
            m_drive.setRobotSpeedType(0, m_goal.velocity*m_dir);
            m_endFlag = true;
        }
    }
