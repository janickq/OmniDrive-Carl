...
public class HolonomicDriveController {
   ...
   * @param profiledPIDController A profiled PID controller to respond to error in angle.
   */
  @SuppressWarnings("ParameterName")
  public HolonomicDriveController(
      PIDController xController, PIDController yController, ProfiledPIDController profiledPIDController) {
    m_xController = xController;
    m_yController = yController;
    m_thetaController = profiledPIDController;
  }
  ...
  public ChassisSpeeds calculate(
    ...
    double xFeedback = m_xController.calculate(currentPose.getTranslation().getX(), poseRef.getTranslation().getX());
    double yFeedback = m_yController.calculate(currentPose.getTranslation().getY(), poseRef.getTranslation().getY());
